...
#ifndef MISSIONIMPOSSIBLE_WINDOW_H
#define MISSIONIMPOSSIBLE_WINDOW_H
...
struct missionImpossible_window : Graph_lib::Window {
    missionImpossible_window(Point xy, int w, int h, const string& title, string playername );
