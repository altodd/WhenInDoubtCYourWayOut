...
intermediate_window::intermediate_window(Point xy, int w, int h, const string& title, string playername) :
	Window(xy, w, h, title),
	...
	uniqueScore(Point(200, 50), 1200, 700, 1, playername),
...
bool intermediate_window::wait_for_button()
// modified event loop:
...
void intermediate_window::cb_maroon(Address, Address pw)
{
	reference_to<intermediate_window>(pw).maroon();
}

void intermediate_window::cb_white(Address, Address pw)
{
	reference_to<intermediate_window>(pw).white();
}

void intermediate_window::cb_black(Address, Address pw)
{
	reference_to<intermediate_window>(pw).black();
}

void intermediate_window::cb_quit(Address, Address pw)
{
	reference_to<intermediate_window>(pw).quitButton();
}

//------------------------------------------------------------------------------
void intermediate_window::quitButton()
{
	exit(0);
}

void intermediate_window::maroon()
{
...
void intermediate_window::white()
{
	if (observation_period == true) {
...
void intermediate_window::black()
{
	if (observation_period == true) {
