...
bool beginner_window::wait_for_button()
// modified event loop:
...
void beginner_window::cb_maroon(Address, Address pw)
{
	reference_to<beginner_window>(pw).maroon();
}

void beginner_window::cb_white(Address, Address pw)
{
	reference_to<beginner_window>(pw).white();
}

void beginner_window::cb_black(Address, Address pw)
{
	reference_to<beginner_window>(pw).black();
}

void beginner_window::cb_quit(Address, Address pw)
{
	reference_to<beginner_window>(pw).quitButton();
}

//------------------------------------------------------------------------------
void beginner_window::quitButton()
{
	exit(0);
}


void beginner_window::maroon()
{
